...
FILES_MATRIX = ${MATRIX}Xmatrix_ng_v.o \
	       ...
	       ${MACROS}Xlumis.o
FILES_INTERF = ${INTERF}Xget_spectrum.o \
	       ${INTERF}Xhard_stop.o \
	       ${INTERF}Xget_pdf.o 
...
prospino:	prospino_main.f90  ${FILES_DIRECT} \
	...
	${COMP} prospino_main.f90  ${FILES_DIRECT} \
	                           ${FILES_MACROS} \
                                   ...
                                   ${FILES_INTEGS} \
                                   ${FILES_STRONG} \
                                   ${FILES_INTERF} -L/afs/hephy.at/user/m/mflechl/opt/lhapdf/local/lib -lLHAPDF -o prospino_2.run
#                                   ${FILES_INTERF} -L/home/rk066459/LHAPDF/lib -lLHAPDF -o prospino_2.run
#
#
#
