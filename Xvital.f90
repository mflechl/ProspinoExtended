...
module xx_pass_integ     ! transfer variable values past vegas 
  ...
  real(kind=double)                  :: scafac2           ! set in PROSPINO 
  real(kind=double)                  :: scafac3           ! set in PROSPINO 
...
!   real(kind=double), parameter, public :: gf=1.1663e-5                 ! set all kinds of
   real(kind=double), parameter, public :: gf=1.16637e-5                 ! set all kinds of
!   real(kind=double),            public :: gf                 ! set all kinds of
...
!   real(kind=double), parameter, public :: mz=91.187, mw=80.41
   real(kind=double),            public :: mz, mw
!   real(kind=double), parameter, public :: mb=4.6,    mt=172.0
   real(kind=double),            public :: mb,    mt
