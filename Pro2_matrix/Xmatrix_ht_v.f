...
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
     &          ,prefac,log_qf,log_qr,kaellen,born,qf,qr,qb,h_l2,h_r2
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
c         transformation top MSbar -> pole mass
      born =
     +  + (0*h_r2+h_l2)*Nc*Cf*Pi*alphas * (  - 8 - 8*s**(-1)*t1 - 8*
     +    s**(-1)*t1**2*u1**(-1) - 4*s**(-1)*u1 + 8*s*m1**2*u1**(-2) - 
     +    4*s*u1**(-1) + 8*m1**2*t1*u1**(-2) + 8*m1**2*u1**(-1) - 8*t1*
     +    u1**(-1) )

      MM_v = MM_v + born * prefac * 4.D0*Pi*alphas * 8.D0 *
     &            (-4.D0/3.D0 - log(qr**2/m1**2))

!      print*,qr," ", qb," 1=", MM_v
c         scale transformation bottom MSbar: qr -> qb
      born =
     +  + (h_r2+0*h_l2)*Nc*Cf*Pi*alphas * (  - 8 - 8*s**(-1)*t1 - 8*
     +    s**(-1)*t1**2*u1**(-1) - 4*s**(-1)*u1 + 8*s*m1**2*u1**(-2) - 
     +    4*s*u1**(-1) + 8*m1**2*t1*u1**(-2) + 8*m1**2*u1**(-1) - 8*t1*
     +    u1**(-1) )
